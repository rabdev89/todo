...
const orchestration_loop_1 = require("./orchestration_loop");
...
class OrchestrationController {
    ...
    static async run(options = {}) {
        ...
        while (continueRunning && stepCount < maxSteps) {
            ...
            try {
                const result = await orchestration_loop_1.OrchestrationLoop.run();
     ...
     */
    static async updateDashboardWithUserInputRequirements() {
        try {
            ...
            const dashboardPath = path_1.default.join(__dirname, '../../../web-applications/bob/dashboard.md');
            await fs_extra_1.default.ensureDir(path_1.default.dirname(dashboardPath));
            await fs_extra_1.default.writeFile(dashboardPath, dashboardContent, 'utf8');
     ...
     */
    static generateUserInputDashboard(status, position) {
