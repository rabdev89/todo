...
exports.sessionCommand = new commander_1.Command('session')
    ...
    try {
        ...
        for (const session of sessions) {
            ...
            console.log(`${session.id.substring(0, 36).padEnd(36)} | ${projectName.padEnd(26)} | ${session.queryCount.toString().padEnd(7)} | ${lastActivity}`);
        }
        console.log();
        sessionManager.close();
    }
    ...
    try {
        ...
        if (stats.learnedPatterns.length > 0) {
            ...
            stats.learnedPatterns.slice(0, 10).forEach((pattern, i) => {
        ...
        if (stats.topFiles.length > 0) {
            ...
            stats.topFiles.slice(0, 5).forEach((file, i) => {
    ...
    .addCommand(new commander_1.Command('current')
    ...
    .addCommand(new commander_1.Command('use')
...
exports.default = exports.sessionCommand;
