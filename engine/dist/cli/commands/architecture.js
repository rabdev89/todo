...
exports.architectureCommand = void 0;
...
exports.architectureCommand = new commander_1.Command('architecture')
    .alias('arch')
    .description('Architecture registry and validation commands')
    .addCommand(new commander_1.Command('register')
    ...
    try {
        ...
        const registry = architecture_registry_1.ArchitectureRegistry.getInstance();
        const responsibilities = options.responsibilities
            ? options.responsibilities.split(',').map((r) => r.trim())
            : [];
    ...
    .addCommand(new commander_1.Command('rules')
...
exports.default = exports.architectureCommand;
