 ...
 */
export const generateArchitectureDesign: ActionHandler = async (
  context
): Promise<ActionResult> => {
  console.log('  Generating architecture design document...');

  const architecturePath = path.join(PROJECT_DIR, 'architecture.md');
 ...
 */
export const validateTechStack: ActionHandler = async (
  context
): Promise<ActionResult> => {
  console.log('  Validating tech stack...');

  const techStackPath = path.join(PROJECT_DIR, 'tech_stack.json');
  ...
  const validations: { component: string; valid: boolean; message?: string }[] = [];
 ...
 */
export const generateDatabaseSchema: ActionHandler = async (
  context
): Promise<ActionResult> => {
  console.log('  Generating database schema...');

  const schemaPath = path.join(WEB_APP_PM_DIR, 'database_schema.md');
  const visionPath = path.join(WEB_APP_PM_DIR, 'vision.md');
  const prdPath = path.join(WEB_APP_PM_DIR, 'PRD.md');
 ...
 */
export const generateApiContracts: ActionHandler = async (
  context
): Promise<ActionResult> => {
  console.log('  Generating API contracts...');

  const apiPath = path.join(WEB_APP_PM_DIR, 'api_contracts.md');
  const visionPath = path.join(WEB_APP_PM_DIR, 'vision.md');
  const prdPath = path.join(WEB_APP_PM_DIR, 'PRD.md');
