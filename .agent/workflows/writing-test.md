...
- Update `project-management/tickets/T-{name}/testing/testing.md` sections with links to test files and results. **Must include evidence of tests passing before marking complete (per `.agent/rules/verification.md`).**
