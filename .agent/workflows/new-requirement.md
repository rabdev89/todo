...
- Source: `project-management/epics/epic_template/tickets/ticket_template/requirements/README.md` → save as `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/requirements/README.md`
- Source: `project-management/epics/epic_template/tickets/ticket_template/design/README.md` → save as `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/design/README.md`
- Source: `project-management/epics/epic_template/tickets/ticket_template/planning/README.md` → save as `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/planning/README.md`
- Source: `project-management/epics/epic_template/tickets/ticket_template/implementation/README.md` → save as `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/implementation/README.md`
- Source: `project-management/epics/epic_template/tickets/ticket_template/testing/README.md` → save as `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/testing/README.md`
...
Help me fill out `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/requirements/README.md`:
...
Guide me through `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/design/README.md`:
...
Help me break down work in `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/planning/README.md`:
...
6. Update `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/implementation/README.md` with notes

## Step 8: Testing Phase

Guide testing in `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/testing/README.md`:
...
- Documented in: `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/requirements/README.md`
...
- Test documentation: `web-applications/project-management/epics/[EPIC-NAME]/tickets/T-{name}/testing/README.md`
